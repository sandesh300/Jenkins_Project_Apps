...
A: Here’s a list of **common plugins used in Jenkins**, especially in real-world DevOps and CI/CD pipelines:
---

### ✅ **1. Git Plugin**

* **Purpose**: Integrates Jenkins with Git repositories (GitHub, GitLab, Bitbucket, etc.)
* **Use**: For cloning code and triggering builds from version control.

---

### ✅ **2. Pipeline Plugin (Declarative and Scripted)**

* **Purpose**: Enables writing complex build pipelines as code (`Jenkinsfile`)
* **Use**: Automates build-test-deploy steps.

---

### ✅ **3. GitHub Integration Plugin**

* **Purpose**: Triggers Jenkins jobs from GitHub events (push, pull requests)
* **Use**: Webhook integration and GitHub OAuth.

---

### ✅ **4. Maven Integration Plugin**

* **Purpose**: Runs Apache Maven build tasks
* **Use**: Useful for Java-based project builds.

---

### ✅ **5. Docker Pipeline Plugin**

* **Purpose**: Enables Docker commands inside Jenkins pipelines.
* **Use**: Build, run, or push Docker containers.

---

### ✅ **6. Blue Ocean Plugin**

* **Purpose**: Provides a modern, user-friendly UI for pipelines.
* **Use**: Better visual representation of pipeline steps.

---

### ✅ **7. Credentials Binding Plugin**

* **Purpose**: Securely uses credentials (API keys, passwords) in builds.
* **Use**: Avoids hardcoding secrets in scripts or Jenkinsfiles.

---

### ✅ **8. Slack Notification Plugin**

* **Purpose**: Sends build notifications to Slack channels.
* **Use**: Alerts for build status (success/failure).

---

### ✅ **9. Email Extension Plugin**

* **Purpose**: Sends customizable email alerts.
* **Use**: Notify teams after build completion or failure.

---

### ✅ **10. Role-based Authorization Strategy**

* **Purpose**: Controls who can do what in Jenkins.
* **Use**: Enforces security and access control.

---

### ✅ **11. SonarQube Scanner Plugin**

* **Purpose**: Integrates SonarQube code quality checks into builds.
* **Use**: Code analysis and bug detection.

---

### ✅ **12. Nexus Artifact Uploader / Artifactory Plugin**

* **Purpose**: Uploads artifacts to repositories like Sonatype Nexus or JFrog Artifactory.
* **Use**: Store and distribute build artifacts.

---

### ✅ **13. Kubernetes Plugin**

* **Purpose**: Allows Jenkins to dynamically spin up build agents in Kubernetes.
* **Use**: Scalable CI/CD on Kubernetes clusters.
